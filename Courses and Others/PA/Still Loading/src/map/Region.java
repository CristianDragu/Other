...
public class Region {
	...
	private int armies, originalArmies;
	...
	public void setArmies(int armies) {
		this.armies = armies;
		this.originalArmies = armies;
	}
	
	public void updateArmies(int armies) {
        this.armies += armies;
    }
	...
	public int getOriginalArmies() {
		return originalArmies;
	}
