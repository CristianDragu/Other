...
#define T6963C_RESET_ENABLE 			T6963C_PORT_CTRL2 &= ~(1<<T6963C_RST)
#define T6963C_RESET_DISABLE 			T6963C_PORT_CTRL2 |= (1<<T6963C_RST)
...
#define T6963C_CE_ENABLE				T6963C_PORT_CTRL2 &= ~(1<<T6963C_CE)
#define T6963C_CE_DISABLE				T6963C_PORT_CTRL2 |= (1<<T6963C_CE)
...
void T6963cInit(uint8_t Options, uint8_t Mode)
{
	...
	T6963C_PORT_CTRL |= (1<<T6963C_WR) | (1<<T6963C_RD);
	T6963C_PORT_CTRL2 |= (1<<T6963C_CE);
	T6963C_PORT_CTRL &= ~(1<<T6963C_CD);
	T6963C_PORT_CTRL2 &= ~(1<<T6963C_RST);
	T6963C_DDR_CTRL	|= (1<<T6963C_WR) | (1<<T6963C_RD) | (1<<T6963C_CD);
	T6963C_DDR_CTRL2|= (1<<T6963C_CE) | (1<<T6963C_RST);
...
void T6963cPutString(const char* pString)
{
...
void T6963cPutString_P(const char* pString)
{
...
{
	T6963cSetAddress(StartAddress);
	T6963cWriteSingleByte(pBuffer, nBytes);
}
