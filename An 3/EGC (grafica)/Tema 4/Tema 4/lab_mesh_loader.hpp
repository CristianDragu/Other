//-------------------------------------------------------------------------------------------------
// Descriere: incarcare de mesh-uri
//
// Nota:
//		loadObj -		functia pe care o veti folosi pentru a incarca mesh-uri de tip .obj.
//						lucreaza cu functii OpenGL pentru a crea un mesh, este functia pe care o veti folosi
//						returneaza 4 valori:
//						- vao = bufferul de stare (stocheaza maparile de terimitere de date catre OpenGL - cele setate cu glVertexAttribPointer)
//						- vbo = bufferul de date (stocheaza datele vertecsilor)
//						- ibo = bufferul de indecsi (stocheaza topologia mesh-ului, ca triunghiuri)
//						- num_indices = nr de indecsi al topologiei
//						
//
//		_loadObjFile	incarca mesh-ul in memorie, independent de OpenGL
//						rol de functie de suport
//
// Nota:
//		sunteti incurajati sa va scrieti parserele proprii pentru alte formaturi. Format sugerat: ply,off
//		Asa veti intelege in profunzime conceptele utilizate in formaturile de date pentru mesh-uri.
//
