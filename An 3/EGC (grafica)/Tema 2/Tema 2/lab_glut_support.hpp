...
namespace lab
{
	...
	struct WindowInfo
	{
		...
		int start_position_x, start_position_y;		// window coordinates
		bool is_reshapable;							// whether or not the window is resizable
	};
	...
	struct ContextInfo
	{
		ContextInfo()
		{
			major_version = 3;						// cel mai nou context e 4.5
